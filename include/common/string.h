...
class CharString {
    ...
    rebel_char_string _char_string;
...
class String {
    ...
    explicit inline String(rebel_string contents) : _rebel_string(contents) {}
...
public:
    ...
    static String chr(rebel_char_type p_char);
