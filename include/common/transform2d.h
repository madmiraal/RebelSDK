...
struct Transform2D {
    ...
    inline real_t tdotx(const Vector2& v) const {
        return elements[0][0] * v.x + elements[1][0] * v.y;
    }

    inline real_t tdoty(const Vector2& v) const {
    ...
    inline Vector2& operator[](int p_idx) {
        return elements[p_idx];
    }
    ...
    inline const Vector2& get_origin() const {
        return elements[2];
    }

    inline void set_origin(const Vector2& p_origin) {
        elements[2] = p_origin;
    }
