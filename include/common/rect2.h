...
struct Rect2 {
    ...
    inline const Vector2& get_position() const {
        return position;
    }

    inline void set_position(const Vector2& p_position) {
        position = p_position;
    }

    inline const Vector2& get_size() const {
        return size;
    }

    inline void set_size(const Vector2& p_size) {
        size = p_size;
    }

    inline real_t get_area() const {
    ...
    inline bool no_area() const {
        return (size.width <= 0 || size.height <= 0);
    }

    inline bool operator==(const Rect2& p_rect) const {
