...
#ifndef REBEL_VISUALSHADERNODETRANSFORMCONSTANT_H
#define REBEL_VISUALSHADERNODETRANSFORMCONSTANT_H
...
public:
    ...
    static VisualShaderNodeTransformConstant* create();
...
#endif // REBEL_VISUALSHADERNODETRANSFORMCONSTANT_H
