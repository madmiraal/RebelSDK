...
#ifndef REBEL_PHYSICS2DTESTMOTIONRESULT_H
#define REBEL_PHYSICS2DTESTMOTIONRESULT_H
...
public:
    ...
    static Physics2DTestMotionResult* create();
...
#endif // REBEL_PHYSICS2DTESTMOTIONRESULT_H
