...
#ifndef REBEL_PHYSICSSHAPEQUERYPARAMETERS_H
#define REBEL_PHYSICSSHAPEQUERYPARAMETERS_H
...
public:
    ...
    static PhysicsShapeQueryParameters* create();
...
#endif // REBEL_PHYSICSSHAPEQUERYPARAMETERS_H
