...
#ifndef REBEL_VISUALSHADERNODESCALARDERIVATIVEFUNC_H
#define REBEL_VISUALSHADERNODESCALARDERIVATIVEFUNC_H
...
public:
    ...
    static VisualShaderNodeScalarDerivativeFunc* create();
...
#endif // REBEL_VISUALSHADERNODESCALARDERIVATIVEFUNC_H
