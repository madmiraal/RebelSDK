...
#ifndef REBEL_VISUALSHADERNODETRANSFORMFUNC_H
#define REBEL_VISUALSHADERNODETRANSFORMFUNC_H
...
public:
    ...
    static VisualShaderNodeTransformFunc* create();
...
#endif // REBEL_VISUALSHADERNODETRANSFORMFUNC_H
