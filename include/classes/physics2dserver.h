...
#ifndef REBEL_PHYSICS2DSERVER_H
#define REBEL_PHYSICS2DSERVER_H
...
public:
    ...
    bool body_test_motion(const RID body, const Transform2D from, const Vector2 motion, const bool infinite_inertia, const real_t margin = 0.08, const Ref<Physics2DTestMotionResult> result = nullptr, const bool exclude_raycast_shapes = true, const Array exclude = Array());
    ...
    static inline Physics2DServer* get_singleton() {
        if (!Physics2DServer::singleton) {
            Physics2DServer::singleton = new Physics2DServer;
        }
        return Physics2DServer::singleton;
    }
...
private:
    ...
    struct MethodBindings {
        ...
        rebel_method_bind* mb_area_attach_canvas_instance_id;
        ...
        rebel_method_bind* mb_area_get_canvas_instance_id;
        ...
        rebel_method_bind* mb_body_attach_canvas_instance_id;
        ...
        rebel_method_bind* mb_body_get_canvas_instance_id;
        rebel_method_bind* mb_body_get_collision_layer;
        rebel_method_bind* mb_body_get_collision_mask;
        rebel_method_bind* mb_body_get_continuous_collision_detection_mode;
        ...
        rebel_method_bind* mb_body_get_shape_metadata;
        ...
        rebel_method_bind* mb_body_set_continuous_collision_detection_mode;
        ...
        rebel_method_bind* mb_body_set_shape_as_one_way_collision;
        rebel_method_bind* mb_body_set_shape_disabled;
        rebel_method_bind* mb_body_set_shape_metadata;
        ...
        rebel_method_bind* mb_capsule_shape_create;
        rebel_method_bind* mb_circle_shape_create;
        rebel_method_bind* mb_concave_polygon_shape_create;
        rebel_method_bind* mb_convex_polygon_shape_create;
        rebel_method_bind* mb_damped_spring_joint_create;
        rebel_method_bind* mb_damped_string_joint_get_param;
        rebel_method_bind* mb_damped_string_joint_set_param;
        rebel_method_bind* mb_free_rid;
        rebel_method_bind* mb_get_process_info;
        rebel_method_bind* mb_groove_joint_create;
        rebel_method_bind* mb_joint_get_param;
        rebel_method_bind* mb_joint_get_type;
        rebel_method_bind* mb_joint_set_param;
        rebel_method_bind* mb_line_shape_create;
        rebel_method_bind* mb_pin_joint_create;
        rebel_method_bind* mb_ray_shape_create;
        rebel_method_bind* mb_rectangle_shape_create;
        rebel_method_bind* mb_segment_shape_create;
