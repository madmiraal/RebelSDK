...
#ifndef REBEL_VISUALSHADERNODESCALAROP_H
#define REBEL_VISUALSHADERNODESCALAROP_H
...
public:
    ...
    static VisualShaderNodeScalarOp* create();
...
#endif // REBEL_VISUALSHADERNODESCALAROP_H
