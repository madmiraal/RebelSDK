...
#ifndef REBEL_VISUALSHADERNODEBOOLEANCONSTANT_H
#define REBEL_VISUALSHADERNODEBOOLEANCONSTANT_H
...
public:
    ...
    static VisualShaderNodeBooleanConstant* create();
...
#endif // REBEL_VISUALSHADERNODEBOOLEANCONSTANT_H
