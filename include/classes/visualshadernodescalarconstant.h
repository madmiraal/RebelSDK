...
#ifndef REBEL_VISUALSHADERNODESCALARCONSTANT_H
#define REBEL_VISUALSHADERNODESCALARCONSTANT_H
...
public:
    ...
    static VisualShaderNodeScalarConstant* create();
...
#endif // REBEL_VISUALSHADERNODESCALARCONSTANT_H
