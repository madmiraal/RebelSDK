...
#ifndef REBEL_PHYSICSSERVER_H
#define REBEL_PHYSICSSERVER_H
...
public:
    ...
    bool body_test_motion(const RID body, const Transform from, const Vector3 motion, const bool infinite_inertia, const Ref<PhysicsTestMotionResult> result = nullptr, const bool exclude_raycast_shapes = true, const Array exclude = Array());
...
private:
    ...
    struct MethodBindings {
        rebel_method_bind* mb_area_add_shape;
        rebel_method_bind* mb_area_attach_object_instance_id;
        rebel_method_bind* mb_area_clear_shapes;
        rebel_method_bind* mb_area_create;
        rebel_method_bind* mb_area_get_object_instance_id;
        rebel_method_bind* mb_area_get_param;
        rebel_method_bind* mb_area_get_shape;
        rebel_method_bind* mb_area_get_shape_count;
        rebel_method_bind* mb_area_get_shape_transform;
        rebel_method_bind* mb_area_get_space;
        rebel_method_bind* mb_area_get_space_override_mode;
        rebel_method_bind* mb_area_get_transform;
        rebel_method_bind* mb_area_is_ray_pickable;
        rebel_method_bind* mb_area_remove_shape;
        rebel_method_bind* mb_area_set_area_monitor_callback;
        rebel_method_bind* mb_area_set_collision_layer;
        rebel_method_bind* mb_area_set_collision_mask;
        rebel_method_bind* mb_area_set_monitor_callback;
        rebel_method_bind* mb_area_set_monitorable;
        rebel_method_bind* mb_area_set_param;
        rebel_method_bind* mb_area_set_ray_pickable;
        rebel_method_bind* mb_area_set_shape;
        rebel_method_bind* mb_area_set_shape_disabled;
        rebel_method_bind* mb_area_set_shape_transform;
        rebel_method_bind* mb_area_set_space;
        rebel_method_bind* mb_area_set_space_override_mode;
        rebel_method_bind* mb_area_set_transform;
        rebel_method_bind* mb_body_add_central_force;
        rebel_method_bind* mb_body_add_collision_exception;
        rebel_method_bind* mb_body_add_force;
        rebel_method_bind* mb_body_add_shape;
        rebel_method_bind* mb_body_add_torque;
        rebel_method_bind* mb_body_apply_central_impulse;
        rebel_method_bind* mb_body_apply_impulse;
        rebel_method_bind* mb_body_apply_torque_impulse;
        rebel_method_bind* mb_body_attach_object_instance_id;
        rebel_method_bind* mb_body_clear_shapes;
        rebel_method_bind* mb_body_create;
        rebel_method_bind* mb_body_get_collision_layer;
        rebel_method_bind* mb_body_get_collision_mask;
        rebel_method_bind* mb_body_get_direct_state;
        rebel_method_bind* mb_body_get_kinematic_safe_margin;
        rebel_method_bind* mb_body_get_max_contacts_reported;
        rebel_method_bind* mb_body_get_mode;
        rebel_method_bind* mb_body_get_object_instance_id;
        rebel_method_bind* mb_body_get_param;
        rebel_method_bind* mb_body_get_shape;
        rebel_method_bind* mb_body_get_shape_count;
        rebel_method_bind* mb_body_get_shape_transform;
        rebel_method_bind* mb_body_get_space;
        rebel_method_bind* mb_body_get_state;
        rebel_method_bind* mb_body_is_axis_locked;
        rebel_method_bind* mb_body_is_continuous_collision_detection_enabled;
        rebel_method_bind* mb_body_is_omitting_force_integration;
        rebel_method_bind* mb_body_is_ray_pickable;
        rebel_method_bind* mb_body_remove_collision_exception;
        rebel_method_bind* mb_body_remove_shape;
        rebel_method_bind* mb_body_set_axis_lock;
        rebel_method_bind* mb_body_set_axis_velocity;
        rebel_method_bind* mb_body_set_collision_layer;
        rebel_method_bind* mb_body_set_collision_mask;
        rebel_method_bind* mb_body_set_enable_continuous_collision_detection;
        rebel_method_bind* mb_body_set_force_integration_callback;
        rebel_method_bind* mb_body_set_kinematic_safe_margin;
        rebel_method_bind* mb_body_set_max_contacts_reported;
        rebel_method_bind* mb_body_set_mode;
        rebel_method_bind* mb_body_set_omit_force_integration;
        rebel_method_bind* mb_body_set_param;
        rebel_method_bind* mb_body_set_ray_pickable;
        rebel_method_bind* mb_body_set_shape;
        rebel_method_bind* mb_body_set_shape_disabled;
        rebel_method_bind* mb_body_set_shape_transform;
        rebel_method_bind* mb_body_set_space;
        rebel_method_bind* mb_body_set_state;
        rebel_method_bind* mb_body_test_motion;
        rebel_method_bind* mb_cone_twist_joint_get_param;
        rebel_method_bind* mb_cone_twist_joint_set_param;
        rebel_method_bind* mb_free_rid;
        rebel_method_bind* mb_generic_6dof_joint_get_flag;
        rebel_method_bind* mb_generic_6dof_joint_get_param;
        rebel_method_bind* mb_generic_6dof_joint_set_flag;
        rebel_method_bind* mb_generic_6dof_joint_set_param;
        rebel_method_bind* mb_get_process_info;
        rebel_method_bind* mb_hinge_joint_get_flag;
        rebel_method_bind* mb_hinge_joint_get_param;
        rebel_method_bind* mb_hinge_joint_set_flag;
        rebel_method_bind* mb_hinge_joint_set_param;
        rebel_method_bind* mb_joint_create_cone_twist;
        rebel_method_bind* mb_joint_create_generic_6dof;
        rebel_method_bind* mb_joint_create_hinge;
        rebel_method_bind* mb_joint_create_pin;
        rebel_method_bind* mb_joint_create_slider;
        rebel_method_bind* mb_joint_get_solver_priority;
        rebel_method_bind* mb_joint_get_type;
        rebel_method_bind* mb_joint_set_solver_priority;
        rebel_method_bind* mb_pin_joint_get_local_a;
        rebel_method_bind* mb_pin_joint_get_local_b;
        rebel_method_bind* mb_pin_joint_get_param;
        rebel_method_bind* mb_pin_joint_set_local_a;
        rebel_method_bind* mb_pin_joint_set_local_b;
        rebel_method_bind* mb_pin_joint_set_param;
        rebel_method_bind* mb_set_active;
        rebel_method_bind* mb_set_collision_iterations;
        rebel_method_bind* mb_shape_create;
        rebel_method_bind* mb_shape_get_data;
        rebel_method_bind* mb_shape_get_type;
        rebel_method_bind* mb_shape_set_data;
        rebel_method_bind* mb_slider_joint_get_param;
        rebel_method_bind* mb_slider_joint_set_param;
        rebel_method_bind* mb_space_create;
        rebel_method_bind* mb_space_get_direct_state;
        rebel_method_bind* mb_space_get_param;
        rebel_method_bind* mb_space_is_active;
        rebel_method_bind* mb_space_set_active;
        rebel_method_bind* mb_space_set_param;
    };
