...
#ifndef REBEL_IMAGE_H
#define REBEL_IMAGE_H
...
public:
    ...
    static const int MAX_HEIGHT = 16384;
    static const int MAX_WIDTH = 16384;
...
private:
    struct MethodBindings {
        ...
        rebel_method_bind* mb_blend_rect;
        rebel_method_bind* mb_blend_rect_mask;
        rebel_method_bind* mb_blit_rect;
        rebel_method_bind* mb_blit_rect_mask;
        rebel_method_bind* mb_bumpmap_to_normalmap;
        rebel_method_bind* mb_clear_mipmaps;
        rebel_method_bind* mb_compress;
        rebel_method_bind* mb_convert;
        rebel_method_bind* mb_copy_from;
        rebel_method_bind* mb_create;
        rebel_method_bind* mb_create_from_data;
        rebel_method_bind* mb_crop;
        rebel_method_bind* mb_decompress;
        rebel_method_bind* mb_detect_alpha;
        rebel_method_bind* mb_expand_x2_hq2x;
        rebel_method_bind* mb_fill;
        rebel_method_bind* mb_fix_alpha_edges;
        rebel_method_bind* mb_flip_x;
        rebel_method_bind* mb_flip_y;
        rebel_method_bind* mb_generate_mipmaps;
        rebel_method_bind* mb_get_data;
        rebel_method_bind* mb_get_format;
        rebel_method_bind* mb_get_height;
        rebel_method_bind* mb_get_mipmap_offset;
        rebel_method_bind* mb_get_pixel;
        rebel_method_bind* mb_get_pixelv;
        ...
        rebel_method_bind* mb_has_mipmaps;
        rebel_method_bind* mb_is_compressed;
        rebel_method_bind* mb_is_empty;
        rebel_method_bind* mb_is_invisible;
        rebel_method_bind* mb_load;
        rebel_method_bind* mb_load_bmp_from_buffer;
        rebel_method_bind* mb_load_jpg_from_buffer;
        rebel_method_bind* mb_load_png_from_buffer;
        rebel_method_bind* mb_load_tga_from_buffer;
        rebel_method_bind* mb_load_webp_from_buffer;
        rebel_method_bind* mb_lock;
        rebel_method_bind* mb_normalmap_to_xy;
        rebel_method_bind* mb_premultiply_alpha;
        rebel_method_bind* mb_resize;
        rebel_method_bind* mb_resize_to_po2;
        rebel_method_bind* mb_rgbe_to_srgb;
        rebel_method_bind* mb_save_exr;
        rebel_method_bind* mb_save_png;
        rebel_method_bind* mb_save_png_to_buffer;
        rebel_method_bind* mb_set_pixel;
        rebel_method_bind* mb_set_pixelv;
        rebel_method_bind* mb_shrink_x2;
        rebel_method_bind* mb_srgb_to_linear;
