...
#ifndef REBEL_TWEEN_H
#define REBEL_TWEEN_H
...
private:
    struct MethodBindings {
        rebel_method_bind* mb__remove_by_uid;
        rebel_method_bind* mb_follow_method;
        rebel_method_bind* mb_follow_property;
        rebel_method_bind* mb_get_runtime;
        rebel_method_bind* mb_get_speed_scale;
        rebel_method_bind* mb_get_tween_process_mode;
        rebel_method_bind* mb_interpolate_callback;
        rebel_method_bind* mb_interpolate_deferred_callback;
        rebel_method_bind* mb_interpolate_method;
        rebel_method_bind* mb_interpolate_property;
        rebel_method_bind* mb_is_active;
        rebel_method_bind* mb_is_repeat;
        rebel_method_bind* mb_remove;
        rebel_method_bind* mb_remove_all;
        rebel_method_bind* mb_reset;
        rebel_method_bind* mb_reset_all;
        rebel_method_bind* mb_resume;
        rebel_method_bind* mb_resume_all;
        rebel_method_bind* mb_seek;
        rebel_method_bind* mb_set_active;
        rebel_method_bind* mb_set_repeat;
        rebel_method_bind* mb_set_speed_scale;
        rebel_method_bind* mb_set_tween_process_mode;
        rebel_method_bind* mb_start;
        rebel_method_bind* mb_stop;
        rebel_method_bind* mb_stop_all;
        rebel_method_bind* mb_targeting_method;
        rebel_method_bind* mb_targeting_property;
        rebel_method_bind* mb_tell;
    };
