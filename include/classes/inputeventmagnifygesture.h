...
#ifndef REBEL_INPUTEVENTMAGNIFYGESTURE_H
#define REBEL_INPUTEVENTMAGNIFYGESTURE_H
...
public:
    ...
    static InputEventMagnifyGesture* create();
...
#endif // REBEL_INPUTEVENTMAGNIFYGESTURE_H
