...
#ifndef REBEL_VISUALSERVER_H
#define REBEL_VISUALSERVER_H
...
public:
    ...
    void light_set_bake_mode(const RID light, const int64_t bake_mode);
    ...
    void mesh_add_surface_from_arrays(const RID mesh, const int64_t primitive, const Array arrays, const Array blend_shapes = Array(), const int64_t compress_format = 2194432);
    ...
    void viewport_set_sharpen_intensity(const RID viewport, const real_t intensity);
    ...
    void viewport_set_use_debanding(const RID viewport, const bool debanding);
    void viewport_set_use_fxaa(const RID viewport, const bool fxaa);
    void viewport_set_vflip(const RID viewport, const bool enabled);

    static inline VisualServer* get_singleton() {
        if (!VisualServer::singleton) {
            VisualServer::singleton = new VisualServer;
        }
        return VisualServer::singleton;
    }
...
private:
    ...
    struct MethodBindings {
        rebel_method_bind* mb_black_bars_set_images;
        rebel_method_bind* mb_black_bars_set_margins;
        rebel_method_bind* mb_camera_create;
        rebel_method_bind* mb_camera_set_cull_mask;
        rebel_method_bind* mb_camera_set_environment;
        rebel_method_bind* mb_camera_set_frustum;
        rebel_method_bind* mb_camera_set_orthogonal;
        rebel_method_bind* mb_camera_set_perspective;
        rebel_method_bind* mb_camera_set_transform;
        rebel_method_bind* mb_camera_set_use_vertical_aspect;
        rebel_method_bind* mb_canvas_create;
        rebel_method_bind* mb_canvas_item_add_circle;
        rebel_method_bind* mb_canvas_item_add_clip_ignore;
        rebel_method_bind* mb_canvas_item_add_line;
        rebel_method_bind* mb_canvas_item_add_mesh;
        rebel_method_bind* mb_canvas_item_add_multimesh;
        rebel_method_bind* mb_canvas_item_add_nine_patch;
        rebel_method_bind* mb_canvas_item_add_particles;
        rebel_method_bind* mb_canvas_item_add_polygon;
        rebel_method_bind* mb_canvas_item_add_polyline;
        rebel_method_bind* mb_canvas_item_add_primitive;
        rebel_method_bind* mb_canvas_item_add_rect;
        rebel_method_bind* mb_canvas_item_add_set_transform;
        rebel_method_bind* mb_canvas_item_add_texture_rect;
        rebel_method_bind* mb_canvas_item_add_texture_rect_region;
        rebel_method_bind* mb_canvas_item_add_triangle_array;
        rebel_method_bind* mb_canvas_item_clear;
        rebel_method_bind* mb_canvas_item_create;
        rebel_method_bind* mb_canvas_item_set_clip;
        rebel_method_bind* mb_canvas_item_set_copy_to_backbuffer;
        rebel_method_bind* mb_canvas_item_set_custom_rect;
        rebel_method_bind* mb_canvas_item_set_distance_field_mode;
        rebel_method_bind* mb_canvas_item_set_draw_behind_parent;
        rebel_method_bind* mb_canvas_item_set_draw_index;
        rebel_method_bind* mb_canvas_item_set_light_mask;
        rebel_method_bind* mb_canvas_item_set_material;
        rebel_method_bind* mb_canvas_item_set_modulate;
        rebel_method_bind* mb_canvas_item_set_parent;
        rebel_method_bind* mb_canvas_item_set_self_modulate;
        rebel_method_bind* mb_canvas_item_set_sort_children_by_y;
        rebel_method_bind* mb_canvas_item_set_transform;
        rebel_method_bind* mb_canvas_item_set_use_parent_material;
        rebel_method_bind* mb_canvas_item_set_visible;
        rebel_method_bind* mb_canvas_item_set_z_as_relative_to_parent;
        rebel_method_bind* mb_canvas_item_set_z_index;
        rebel_method_bind* mb_canvas_light_attach_to_canvas;
        rebel_method_bind* mb_canvas_light_create;
        rebel_method_bind* mb_canvas_light_occluder_attach_to_canvas;
        rebel_method_bind* mb_canvas_light_occluder_create;
        rebel_method_bind* mb_canvas_light_occluder_set_enabled;
        rebel_method_bind* mb_canvas_light_occluder_set_light_mask;
        rebel_method_bind* mb_canvas_light_occluder_set_polygon;
        rebel_method_bind* mb_canvas_light_occluder_set_transform;
        rebel_method_bind* mb_canvas_light_set_color;
        rebel_method_bind* mb_canvas_light_set_enabled;
        rebel_method_bind* mb_canvas_light_set_energy;
        rebel_method_bind* mb_canvas_light_set_height;
        rebel_method_bind* mb_canvas_light_set_item_cull_mask;
        rebel_method_bind* mb_canvas_light_set_item_shadow_cull_mask;
        rebel_method_bind* mb_canvas_light_set_layer_range;
        rebel_method_bind* mb_canvas_light_set_mode;
        rebel_method_bind* mb_canvas_light_set_scale;
        rebel_method_bind* mb_canvas_light_set_shadow_buffer_size;
        rebel_method_bind* mb_canvas_light_set_shadow_color;
        rebel_method_bind* mb_canvas_light_set_shadow_enabled;
        rebel_method_bind* mb_canvas_light_set_shadow_filter;
        rebel_method_bind* mb_canvas_light_set_shadow_gradient_length;
        rebel_method_bind* mb_canvas_light_set_shadow_smooth;
        rebel_method_bind* mb_canvas_light_set_texture;
        rebel_method_bind* mb_canvas_light_set_texture_offset;
        rebel_method_bind* mb_canvas_light_set_transform;
        rebel_method_bind* mb_canvas_light_set_z_range;
        rebel_method_bind* mb_canvas_occluder_polygon_create;
        rebel_method_bind* mb_canvas_occluder_polygon_set_cull_mode;
        rebel_method_bind* mb_canvas_occluder_polygon_set_shape;
        rebel_method_bind* mb_canvas_occluder_polygon_set_shape_as_lines;
        rebel_method_bind* mb_canvas_set_item_mirroring;
        rebel_method_bind* mb_canvas_set_modulate;
        rebel_method_bind* mb_directional_light_create;
        rebel_method_bind* mb_draw;
        rebel_method_bind* mb_environment_create;
        rebel_method_bind* mb_environment_set_adjustment;
        rebel_method_bind* mb_environment_set_ambient_light;
        rebel_method_bind* mb_environment_set_background;
        rebel_method_bind* mb_environment_set_bg_color;
        rebel_method_bind* mb_environment_set_bg_energy;
        rebel_method_bind* mb_environment_set_canvas_max_layer;
        rebel_method_bind* mb_environment_set_dof_blur_far;
        rebel_method_bind* mb_environment_set_dof_blur_near;
        rebel_method_bind* mb_environment_set_fog;
        rebel_method_bind* mb_environment_set_fog_depth;
        rebel_method_bind* mb_environment_set_fog_height;
        rebel_method_bind* mb_environment_set_glow;
        rebel_method_bind* mb_environment_set_sky;
        rebel_method_bind* mb_environment_set_sky_custom_fov;
        rebel_method_bind* mb_environment_set_sky_orientation;
        rebel_method_bind* mb_environment_set_ssao;
        rebel_method_bind* mb_environment_set_ssr;
        rebel_method_bind* mb_environment_set_tonemap;
        rebel_method_bind* mb_finish;
        rebel_method_bind* mb_force_draw;
        rebel_method_bind* mb_force_sync;
        rebel_method_bind* mb_free_rid;
        rebel_method_bind* mb_get_render_info;
        rebel_method_bind* mb_get_test_cube;
        rebel_method_bind* mb_get_test_texture;
        rebel_method_bind* mb_get_video_adapter_name;
        rebel_method_bind* mb_get_video_adapter_vendor;
        rebel_method_bind* mb_get_white_texture;
        rebel_method_bind* mb_gi_probe_create;
        rebel_method_bind* mb_gi_probe_get_bias;
        rebel_method_bind* mb_gi_probe_get_bounds;
        rebel_method_bind* mb_gi_probe_get_cell_size;
        rebel_method_bind* mb_gi_probe_get_dynamic_data;
        rebel_method_bind* mb_gi_probe_get_dynamic_range;
        rebel_method_bind* mb_gi_probe_get_energy;
        rebel_method_bind* mb_gi_probe_get_normal_bias;
        rebel_method_bind* mb_gi_probe_get_propagation;
        rebel_method_bind* mb_gi_probe_get_to_cell_xform;
        rebel_method_bind* mb_gi_probe_is_compressed;
        rebel_method_bind* mb_gi_probe_is_interior;
        rebel_method_bind* mb_gi_probe_set_bias;
        rebel_method_bind* mb_gi_probe_set_bounds;
        rebel_method_bind* mb_gi_probe_set_cell_size;
        rebel_method_bind* mb_gi_probe_set_compress;
        rebel_method_bind* mb_gi_probe_set_dynamic_data;
        rebel_method_bind* mb_gi_probe_set_dynamic_range;
        rebel_method_bind* mb_gi_probe_set_energy;
        rebel_method_bind* mb_gi_probe_set_interior;
        rebel_method_bind* mb_gi_probe_set_normal_bias;
        rebel_method_bind* mb_gi_probe_set_propagation;
        rebel_method_bind* mb_gi_probe_set_to_cell_xform;
        rebel_method_bind* mb_has_changed;
        rebel_method_bind* mb_has_feature;
        rebel_method_bind* mb_has_os_feature;
        rebel_method_bind* mb_immediate_begin;
        rebel_method_bind* mb_immediate_clear;
        rebel_method_bind* mb_immediate_color;
        rebel_method_bind* mb_immediate_create;
        rebel_method_bind* mb_immediate_end;
        rebel_method_bind* mb_immediate_get_material;
        rebel_method_bind* mb_immediate_normal;
        rebel_method_bind* mb_immediate_set_material;
        rebel_method_bind* mb_immediate_tangent;
        rebel_method_bind* mb_immediate_uv;
        rebel_method_bind* mb_immediate_uv2;
        rebel_method_bind* mb_immediate_vertex;
        rebel_method_bind* mb_immediate_vertex_2d;
        rebel_method_bind* mb_init;
        rebel_method_bind* mb_instance_attach_object_instance_id;
        rebel_method_bind* mb_instance_attach_skeleton;
        rebel_method_bind* mb_instance_create;
        rebel_method_bind* mb_instance_create2;
        rebel_method_bind* mb_instance_geometry_set_as_instance_lod;
        rebel_method_bind* mb_instance_geometry_set_cast_shadows_setting;
        rebel_method_bind* mb_instance_geometry_set_draw_range;
        rebel_method_bind* mb_instance_geometry_set_flag;
        rebel_method_bind* mb_instance_geometry_set_material_override;
        rebel_method_bind* mb_instance_set_base;
        rebel_method_bind* mb_instance_set_blend_shape_weight;
        rebel_method_bind* mb_instance_set_custom_aabb;
        rebel_method_bind* mb_instance_set_exterior;
        rebel_method_bind* mb_instance_set_extra_visibility_margin;
        rebel_method_bind* mb_instance_set_layer_mask;
        rebel_method_bind* mb_instance_set_scenario;
        rebel_method_bind* mb_instance_set_surface_material;
        rebel_method_bind* mb_instance_set_transform;
        rebel_method_bind* mb_instance_set_use_lightmap;
        rebel_method_bind* mb_instance_set_visible;
        rebel_method_bind* mb_instances_cull_aabb;
        rebel_method_bind* mb_instances_cull_convex;
        rebel_method_bind* mb_instances_cull_ray;
        rebel_method_bind* mb_is_render_loop_enabled;
        rebel_method_bind* mb_light_directional_set_blend_splits;
        rebel_method_bind* mb_light_directional_set_shadow_depth_range_mode;
        rebel_method_bind* mb_light_directional_set_shadow_mode;
        rebel_method_bind* mb_light_omni_set_shadow_detail;
        rebel_method_bind* mb_light_omni_set_shadow_mode;
        rebel_method_bind* mb_light_set_bake_mode;
        rebel_method_bind* mb_light_set_color;
        rebel_method_bind* mb_light_set_cull_mask;
        rebel_method_bind* mb_light_set_negative;
        rebel_method_bind* mb_light_set_param;
        rebel_method_bind* mb_light_set_projector;
        rebel_method_bind* mb_light_set_reverse_cull_face_mode;
        rebel_method_bind* mb_light_set_shadow;
        rebel_method_bind* mb_light_set_shadow_color;
        rebel_method_bind* mb_light_set_use_gi;
        rebel_method_bind* mb_lightmap_capture_create;
        rebel_method_bind* mb_lightmap_capture_get_bounds;
        rebel_method_bind* mb_lightmap_capture_get_energy;
        rebel_method_bind* mb_lightmap_capture_get_octree;
        rebel_method_bind* mb_lightmap_capture_get_octree_cell_subdiv;
        rebel_method_bind* mb_lightmap_capture_get_octree_cell_transform;
        rebel_method_bind* mb_lightmap_capture_is_interior;
        rebel_method_bind* mb_lightmap_capture_set_bounds;
        rebel_method_bind* mb_lightmap_capture_set_energy;
        rebel_method_bind* mb_lightmap_capture_set_interior;
        rebel_method_bind* mb_lightmap_capture_set_octree;
        rebel_method_bind* mb_lightmap_capture_set_octree_cell_subdiv;
        rebel_method_bind* mb_lightmap_capture_set_octree_cell_transform;
        rebel_method_bind* mb_make_sphere_mesh;
        rebel_method_bind* mb_material_create;
        rebel_method_bind* mb_material_get_param;
        rebel_method_bind* mb_material_get_param_default;
        rebel_method_bind* mb_material_get_shader;
        rebel_method_bind* mb_material_set_line_width;
        rebel_method_bind* mb_material_set_next_pass;
        rebel_method_bind* mb_material_set_param;
        rebel_method_bind* mb_material_set_render_priority;
        rebel_method_bind* mb_material_set_shader;
        rebel_method_bind* mb_mesh_add_surface_from_arrays;
        rebel_method_bind* mb_mesh_clear;
        rebel_method_bind* mb_mesh_create;
        rebel_method_bind* mb_mesh_get_blend_shape_count;
        rebel_method_bind* mb_mesh_get_blend_shape_mode;
        rebel_method_bind* mb_mesh_get_custom_aabb;
        rebel_method_bind* mb_mesh_get_surface_count;
        rebel_method_bind* mb_mesh_remove_surface;
        rebel_method_bind* mb_mesh_set_blend_shape_count;
        rebel_method_bind* mb_mesh_set_blend_shape_mode;
        rebel_method_bind* mb_mesh_set_custom_aabb;
        rebel_method_bind* mb_mesh_surface_get_aabb;
        rebel_method_bind* mb_mesh_surface_get_array;
        rebel_method_bind* mb_mesh_surface_get_array_index_len;
        rebel_method_bind* mb_mesh_surface_get_array_len;
        rebel_method_bind* mb_mesh_surface_get_arrays;
        rebel_method_bind* mb_mesh_surface_get_blend_shape_arrays;
        rebel_method_bind* mb_mesh_surface_get_format;
        rebel_method_bind* mb_mesh_surface_get_format_offset;
        rebel_method_bind* mb_mesh_surface_get_format_stride;
        rebel_method_bind* mb_mesh_surface_get_index_array;
        rebel_method_bind* mb_mesh_surface_get_material;
        rebel_method_bind* mb_mesh_surface_get_primitive_type;
        rebel_method_bind* mb_mesh_surface_get_skeleton_aabb;
        rebel_method_bind* mb_mesh_surface_set_material;
        rebel_method_bind* mb_mesh_surface_update_region;
        rebel_method_bind* mb_multimesh_allocate;
        rebel_method_bind* mb_multimesh_create;
        rebel_method_bind* mb_multimesh_get_aabb;
        rebel_method_bind* mb_multimesh_get_instance_count;
        rebel_method_bind* mb_multimesh_get_mesh;
        rebel_method_bind* mb_multimesh_get_visible_instances;
        rebel_method_bind* mb_multimesh_instance_get_color;
        rebel_method_bind* mb_multimesh_instance_get_custom_data;
        rebel_method_bind* mb_multimesh_instance_get_transform;
        rebel_method_bind* mb_multimesh_instance_get_transform_2d;
        rebel_method_bind* mb_multimesh_instance_set_color;
        rebel_method_bind* mb_multimesh_instance_set_custom_data;
        rebel_method_bind* mb_multimesh_instance_set_transform;
        rebel_method_bind* mb_multimesh_instance_set_transform_2d;
        rebel_method_bind* mb_multimesh_set_as_bulk_array;
        rebel_method_bind* mb_multimesh_set_mesh;
        rebel_method_bind* mb_multimesh_set_visible_instances;
        rebel_method_bind* mb_omni_light_create;
        rebel_method_bind* mb_particles_create;
        rebel_method_bind* mb_particles_get_current_aabb;
        rebel_method_bind* mb_particles_get_emitting;
        rebel_method_bind* mb_particles_is_inactive;
        rebel_method_bind* mb_particles_request_process;
        rebel_method_bind* mb_particles_restart;
        rebel_method_bind* mb_particles_set_amount;
        rebel_method_bind* mb_particles_set_custom_aabb;
        rebel_method_bind* mb_particles_set_draw_order;
        rebel_method_bind* mb_particles_set_draw_pass_mesh;
        rebel_method_bind* mb_particles_set_draw_passes;
        rebel_method_bind* mb_particles_set_emission_transform;
        rebel_method_bind* mb_particles_set_emitting;
        rebel_method_bind* mb_particles_set_explosiveness_ratio;
        rebel_method_bind* mb_particles_set_fixed_fps;
        rebel_method_bind* mb_particles_set_fractional_delta;
        rebel_method_bind* mb_particles_set_lifetime;
        rebel_method_bind* mb_particles_set_one_shot;
        rebel_method_bind* mb_particles_set_pre_process_time;
        rebel_method_bind* mb_particles_set_process_material;
        rebel_method_bind* mb_particles_set_randomness_ratio;
        rebel_method_bind* mb_particles_set_speed_scale;
        rebel_method_bind* mb_particles_set_use_local_coordinates;
        rebel_method_bind* mb_reflection_probe_create;
        rebel_method_bind* mb_reflection_probe_set_as_interior;
        rebel_method_bind* mb_reflection_probe_set_cull_mask;
        rebel_method_bind* mb_reflection_probe_set_enable_box_projection;
        rebel_method_bind* mb_reflection_probe_set_enable_shadows;
        rebel_method_bind* mb_reflection_probe_set_extents;
        rebel_method_bind* mb_reflection_probe_set_intensity;
        rebel_method_bind* mb_reflection_probe_set_interior_ambient;
        rebel_method_bind* mb_reflection_probe_set_interior_ambient_energy;
        rebel_method_bind* mb_reflection_probe_set_interior_ambient_probe_contribution;
        rebel_method_bind* mb_reflection_probe_set_max_distance;
        rebel_method_bind* mb_reflection_probe_set_origin_offset;
        rebel_method_bind* mb_reflection_probe_set_update_mode;
        rebel_method_bind* mb_request_frame_drawn_callback;
        rebel_method_bind* mb_scenario_create;
        rebel_method_bind* mb_scenario_set_debug;
        rebel_method_bind* mb_scenario_set_environment;
        rebel_method_bind* mb_scenario_set_fallback_environment;
        rebel_method_bind* mb_scenario_set_reflection_atlas_size;
        rebel_method_bind* mb_set_boot_image;
        rebel_method_bind* mb_set_debug_generate_wireframes;
        rebel_method_bind* mb_set_default_clear_color;
        rebel_method_bind* mb_set_render_loop_enabled;
        rebel_method_bind* mb_set_shader_time_scale;
        rebel_method_bind* mb_set_use_occlusion_culling;
        rebel_method_bind* mb_shader_create;
        rebel_method_bind* mb_shader_get_code;
        rebel_method_bind* mb_shader_get_default_texture_param;
        rebel_method_bind* mb_shader_get_param_list;
        rebel_method_bind* mb_shader_set_code;
        rebel_method_bind* mb_shader_set_default_texture_param;
        rebel_method_bind* mb_skeleton_allocate;
        rebel_method_bind* mb_skeleton_bone_get_transform;
        rebel_method_bind* mb_skeleton_bone_get_transform_2d;
        rebel_method_bind* mb_skeleton_bone_set_transform;
        rebel_method_bind* mb_skeleton_bone_set_transform_2d;
        rebel_method_bind* mb_skeleton_create;
        rebel_method_bind* mb_skeleton_get_bone_count;
        rebel_method_bind* mb_sky_create;
        rebel_method_bind* mb_sky_set_texture;
        rebel_method_bind* mb_spot_light_create;
        rebel_method_bind* mb_sync;
        rebel_method_bind* mb_texture_allocate;
        rebel_method_bind* mb_texture_bind;
        rebel_method_bind* mb_texture_create;
        rebel_method_bind* mb_texture_create_from_image;
        rebel_method_bind* mb_texture_debug_usage;
        rebel_method_bind* mb_texture_get_data;
        rebel_method_bind* mb_texture_get_depth;
        rebel_method_bind* mb_texture_get_flags;
        rebel_method_bind* mb_texture_get_format;
        rebel_method_bind* mb_texture_get_height;
        rebel_method_bind* mb_texture_get_path;
        rebel_method_bind* mb_texture_get_texid;
        rebel_method_bind* mb_texture_get_type;
        rebel_method_bind* mb_texture_get_width;
        rebel_method_bind* mb_texture_set_data;
        rebel_method_bind* mb_texture_set_data_partial;
        rebel_method_bind* mb_texture_set_flags;
        rebel_method_bind* mb_texture_set_path;
        rebel_method_bind* mb_texture_set_shrink_all_x2_on_set_data;
        rebel_method_bind* mb_texture_set_size_override;
        rebel_method_bind* mb_textures_keep_original;
        rebel_method_bind* mb_viewport_attach_camera;
        rebel_method_bind* mb_viewport_attach_canvas;
        rebel_method_bind* mb_viewport_attach_to_screen;
        rebel_method_bind* mb_viewport_create;
        rebel_method_bind* mb_viewport_detach;
        rebel_method_bind* mb_viewport_get_render_info;
        rebel_method_bind* mb_viewport_get_texture;
        rebel_method_bind* mb_viewport_remove_canvas;
        rebel_method_bind* mb_viewport_set_active;
        rebel_method_bind* mb_viewport_set_canvas_stacking;
        rebel_method_bind* mb_viewport_set_canvas_transform;
        rebel_method_bind* mb_viewport_set_clear_mode;
        rebel_method_bind* mb_viewport_set_debug_draw;
        rebel_method_bind* mb_viewport_set_disable_3d;
        rebel_method_bind* mb_viewport_set_disable_environment;
        rebel_method_bind* mb_viewport_set_global_canvas_transform;
        rebel_method_bind* mb_viewport_set_hdr;
        rebel_method_bind* mb_viewport_set_hide_canvas;
        rebel_method_bind* mb_viewport_set_hide_scenario;
        rebel_method_bind* mb_viewport_set_msaa;
        rebel_method_bind* mb_viewport_set_parent_viewport;
        rebel_method_bind* mb_viewport_set_render_direct_to_screen;
        rebel_method_bind* mb_viewport_set_scenario;
        rebel_method_bind* mb_viewport_set_shadow_atlas_quadrant_subdivision;
        rebel_method_bind* mb_viewport_set_shadow_atlas_size;
        rebel_method_bind* mb_viewport_set_sharpen_intensity;
        rebel_method_bind* mb_viewport_set_size;
        rebel_method_bind* mb_viewport_set_transparent_background;
        rebel_method_bind* mb_viewport_set_update_mode;
        rebel_method_bind* mb_viewport_set_usage;
        rebel_method_bind* mb_viewport_set_use_arvr;
        rebel_method_bind* mb_viewport_set_use_debanding;
        rebel_method_bind* mb_viewport_set_use_fxaa;
        rebel_method_bind* mb_viewport_set_vflip;
    };
