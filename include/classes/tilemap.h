...
#ifndef REBEL_TILEMAP_H
#define REBEL_TILEMAP_H
...
private:
    struct MethodBindings {
        rebel_method_bind* mb__clear_quadrants;
        rebel_method_bind* mb__get_old_cell_size;
        rebel_method_bind* mb__get_tile_data;
        rebel_method_bind* mb__recreate_quadrants;
        rebel_method_bind* mb__set_celld;
        rebel_method_bind* mb__set_old_cell_size;
        rebel_method_bind* mb__set_tile_data;
        rebel_method_bind* mb_clear;
        rebel_method_bind* mb_fix_invalid_tiles;
        rebel_method_bind* mb_get_cell;
        rebel_method_bind* mb_get_cell_autotile_coord;
        rebel_method_bind* mb_get_cell_size;
        rebel_method_bind* mb_get_cellv;
        rebel_method_bind* mb_get_clip_uv;
        rebel_method_bind* mb_get_collision_bounce;
        rebel_method_bind* mb_get_collision_friction;
        ...
        rebel_method_bind* mb_get_collision_use_kinematic;
        rebel_method_bind* mb_get_collision_use_parent;
        rebel_method_bind* mb_get_custom_transform;
        rebel_method_bind* mb_get_half_offset;
        rebel_method_bind* mb_get_mode;
        rebel_method_bind* mb_get_occluder_light_mask;
        rebel_method_bind* mb_get_quadrant_size;
        rebel_method_bind* mb_get_tile_origin;
        rebel_method_bind* mb_get_tileset;
        rebel_method_bind* mb_get_used_cells;
        rebel_method_bind* mb_get_used_cells_by_id;
        rebel_method_bind* mb_get_used_rect;
        rebel_method_bind* mb_is_cell_transposed;
        rebel_method_bind* mb_is_cell_x_flipped;
        rebel_method_bind* mb_is_cell_y_flipped;
        rebel_method_bind* mb_is_centered_textures_enabled;
        rebel_method_bind* mb_is_compatibility_mode_enabled;
        rebel_method_bind* mb_is_show_collision_enabled;
        rebel_method_bind* mb_is_y_sort_mode_enabled;
        rebel_method_bind* mb_map_to_world;
        rebel_method_bind* mb_set_cell;
        rebel_method_bind* mb_set_cell_size;
        rebel_method_bind* mb_set_cellv;
        rebel_method_bind* mb_set_centered_textures;
        rebel_method_bind* mb_set_clip_uv;
        rebel_method_bind* mb_set_collision_bounce;
        rebel_method_bind* mb_set_collision_friction;
        ...
        rebel_method_bind* mb_set_collision_use_kinematic;
        rebel_method_bind* mb_set_collision_use_parent;
        rebel_method_bind* mb_set_compatibility_mode;
        rebel_method_bind* mb_set_custom_transform;
        rebel_method_bind* mb_set_half_offset;
        rebel_method_bind* mb_set_mode;
        rebel_method_bind* mb_set_occluder_light_mask;
        rebel_method_bind* mb_set_quadrant_size;
        rebel_method_bind* mb_set_show_collision;
        rebel_method_bind* mb_set_tile_origin;
        rebel_method_bind* mb_set_tileset;
        rebel_method_bind* mb_set_y_sort_mode;
        rebel_method_bind* mb_update_bitmask_area;
        rebel_method_bind* mb_update_bitmask_region;
        rebel_method_bind* mb_update_dirty_quadrants;
