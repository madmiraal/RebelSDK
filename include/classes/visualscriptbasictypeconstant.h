...
#ifndef REBEL_VISUALSCRIPTBASICTYPECONSTANT_H
#define REBEL_VISUALSCRIPTBASICTYPECONSTANT_H
...
public:
    ...
    static VisualScriptBasicTypeConstant* create();
...
private:
    struct MethodBindings {
        ...
        rebel_method_bind* mb_get_basic_type_constant;
        rebel_method_bind* mb_set_basic_type;
        rebel_method_bind* mb_set_basic_type_constant;
    };
...
#endif // REBEL_VISUALSCRIPTBASICTYPECONSTANT_H
