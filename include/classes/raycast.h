...
#ifndef REBEL_RAYCAST_H
#define REBEL_RAYCAST_H
...
public:
    ...
    int64_t get_debug_shape_thickness() const;
    ...
    void set_debug_shape_thickness(const int64_t debug_shape_thickness);
...
private:
    struct MethodBindings {
        ...
        rebel_method_bind* mb_get_debug_shape_custom_color;
        rebel_method_bind* mb_get_debug_shape_thickness;
        ...
        rebel_method_bind* mb_set_debug_shape_custom_color;
        rebel_method_bind* mb_set_debug_shape_thickness;
