...
void Engine::___init_method_bindings() {
	...
	___mb.mb_is_printing_error_messages = godot::api->godot_method_bind_get_method("_Engine", "is_printing_error_messages");
	...
	___mb.mb_set_print_error_messages = godot::api->godot_method_bind_get_method("_Engine", "set_print_error_messages");
	...
	godot::api->godot_string_name_new_data(&class_name, "_Engine");
