...
#include <PhysicsTestMotionResult.hpp>
...
void ___register_types()
{
	...
	godot::_TagDB::register_global_type("AESContext", typeid(AESContext).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("ARVRPositionalTracker", typeid(ARVRPositionalTracker).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("AspectRatioContainer", typeid(AspectRatioContainer).hash_code(), typeid(Container).hash_code());
	...
	godot::_TagDB::register_global_type("AudioEffectCapture", typeid(AudioEffectCapture).hash_code(), typeid(AudioEffect).hash_code());
	...
	godot::_TagDB::register_global_type("AudioStreamMP3", typeid(AudioStreamMP3).hash_code(), typeid(AudioStream).hash_code());
	...
	godot::_TagDB::register_global_type("CullInstance", typeid(CullInstance).hash_code(), typeid(Spatial).hash_code());
	...
	godot::_TagDB::register_global_type("DTLSServer", typeid(DTLSServer).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("EditorResourcePicker", typeid(EditorResourcePicker).hash_code(), typeid(HBoxContainer).hash_code());
	...
	godot::_TagDB::register_global_type("EditorSceneImporterFBX", typeid(EditorSceneImporterFBX).hash_code(), typeid(EditorSceneImporter).hash_code());
	godot::_TagDB::register_global_type("EditorSceneImporterGLTF", typeid(EditorSceneImporterGLTF).hash_code(), typeid(EditorSceneImporter).hash_code());
	...
	godot::_TagDB::register_global_type("EditorScriptPicker", typeid(EditorScriptPicker).hash_code(), typeid(EditorResourcePicker).hash_code());
	...
	godot::_TagDB::register_global_type("ExternalTexture", typeid(ExternalTexture).hash_code(), typeid(Texture).hash_code());
	godot::_TagDB::register_global_type("FileDialog", typeid(FileDialog).hash_code(), typeid(ConfirmationDialog).hash_code());
	godot::_TagDB::register_global_type("FileSystemDock", typeid(FileSystemDock).hash_code(), typeid(VBoxContainer).hash_code());
	...
	godot::_TagDB::register_global_type("GLTFAccessor", typeid(GLTFAccessor).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFAnimation", typeid(GLTFAnimation).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFBufferView", typeid(GLTFBufferView).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFCamera", typeid(GLTFCamera).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFDocument", typeid(GLTFDocument).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFLight", typeid(GLTFLight).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFMesh", typeid(GLTFMesh).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFNode", typeid(GLTFNode).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFSkeleton", typeid(GLTFSkeleton).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFSkin", typeid(GLTFSkin).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFSpecGloss", typeid(GLTFSpecGloss).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFState", typeid(GLTFState).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("GLTFTexture", typeid(GLTFTexture).hash_code(), typeid(Resource).hash_code());
	...
	godot::_TagDB::register_global_type("HMACContext", typeid(HMACContext).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("JNISingleton", typeid(JNISingleton).hash_code(), typeid(Object).hash_code());
	...
	godot::_TagDB::register_global_type("JavaScriptObject", typeid(JavaScriptObject).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("Listener2D", typeid(Listener2D).hash_code(), typeid(Node2D).hash_code());
	...
	godot::_TagDB::register_global_type("Occluder", typeid(Occluder).hash_code(), typeid(Spatial).hash_code());
	godot::_TagDB::register_global_type("OccluderPolygon2D", typeid(OccluderPolygon2D).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("OccluderShape", typeid(OccluderShape).hash_code(), typeid(Resource).hash_code());
	godot::_TagDB::register_global_type("OccluderShapeSphere", typeid(OccluderShapeSphere).hash_code(), typeid(OccluderShape).hash_code());
	...
	godot::_TagDB::register_global_type("PackedSceneGLTF", typeid(PackedSceneGLTF).hash_code(), typeid(PackedScene).hash_code());
	godot::_TagDB::register_global_type("PacketPeer", typeid(PacketPeer).hash_code(), typeid(Reference).hash_code());
	godot::_TagDB::register_global_type("PacketPeerDTLS", typeid(PacketPeerDTLS).hash_code(), typeid(PacketPeer).hash_code());
	...
	godot::_TagDB::register_global_type("PhysicsTestMotionResult", typeid(PhysicsTestMotionResult).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("Portal", typeid(Portal).hash_code(), typeid(Spatial).hash_code());
	...
	godot::_TagDB::register_global_type("Room", typeid(Room).hash_code(), typeid(Spatial).hash_code());
	godot::_TagDB::register_global_type("RoomGroup", typeid(RoomGroup).hash_code(), typeid(Spatial).hash_code());
	godot::_TagDB::register_global_type("RoomManager", typeid(RoomManager).hash_code(), typeid(Spatial).hash_code());
	...
	godot::_TagDB::register_global_type("UDPServer", typeid(UDPServer).hash_code(), typeid(Reference).hash_code());
	...
	godot::_TagDB::register_global_type("VisibilityNotifier", typeid(VisibilityNotifier).hash_code(), typeid(CullInstance).hash_code());
	...
	godot::_TagDB::register_global_type("VisualShaderNodeUniformRef", typeid(VisualShaderNodeUniformRef).hash_code(), typeid(VisualShaderNode).hash_code());
	...
	godot::_TagDB::register_global_type("WebXRInterface", typeid(WebXRInterface).hash_code(), typeid(ARVRInterface).hash_code());
	...
	godot::_TagDB::register_global_type("_Marshalls", typeid(Marshalls).hash_code(), typeid(Object).hash_code());
