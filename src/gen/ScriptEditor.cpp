...
void *ScriptEditor::_detail_class_tag = nullptr;
...
void ScriptEditor::___init_method_bindings() {
	...
	___mb.mb__input = godot::api->godot_method_bind_get_method("ScriptEditor", "_input");
	...
	___mb.mb__queue_close_tabs = godot::api->godot_method_bind_get_method("ScriptEditor", "_queue_close_tabs");
	...
	godot::api->godot_string_name_new_data(&class_name, "ScriptEditor");
