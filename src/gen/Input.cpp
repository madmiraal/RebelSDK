...
void Input::___init_method_bindings() {
	...
	___mb.mb_flush_buffered_events = godot::api->godot_method_bind_get_method("Input", "flush_buffered_events");
	___mb.mb_get_accelerometer = godot::api->godot_method_bind_get_method("Input", "get_accelerometer");
	___mb.mb_get_action_raw_strength = godot::api->godot_method_bind_get_method("Input", "get_action_raw_strength");
	___mb.mb_get_action_strength = godot::api->godot_method_bind_get_method("Input", "get_action_strength");
	___mb.mb_get_axis = godot::api->godot_method_bind_get_method("Input", "get_axis");
	...
	___mb.mb_get_vector = godot::api->godot_method_bind_get_method("Input", "get_vector");
	...
	___mb.mb_is_physical_key_pressed = godot::api->godot_method_bind_get_method("Input", "is_physical_key_pressed");
	...
	___mb.mb_set_accelerometer = godot::api->godot_method_bind_get_method("Input", "set_accelerometer");
	...
	___mb.mb_set_gravity = godot::api->godot_method_bind_get_method("Input", "set_gravity");
	___mb.mb_set_gyroscope = godot::api->godot_method_bind_get_method("Input", "set_gyroscope");
	___mb.mb_set_magnetometer = godot::api->godot_method_bind_get_method("Input", "set_magnetometer");
	...
	godot::api->godot_string_name_new_data(&class_name, "Input");
