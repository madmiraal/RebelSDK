...
void *EditorSceneImporter::_detail_class_tag = nullptr;
...
void EditorSceneImporter::___init_method_bindings() {
	...
	godot::api->godot_string_name_new_data(&class_name, "EditorSceneImporter");
...
Node *EditorSceneImporter::import_scene_from_other_importer(const String path, const int64_t flags, const int64_t bake_fps, const int64_t compress_flags) {
	return (Node *) ___godot_icall_Object_String_int_int_int(___mb.mb_import_scene_from_other_importer, (const Object *) this, path, flags, bake_fps, compress_flags);
}
