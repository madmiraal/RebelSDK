...
void *CollisionObject2D::_detail_class_tag = nullptr;
...
void CollisionObject2D::___init_method_bindings() {
	...
	___mb.mb_get_collision_layer = godot::api->godot_method_bind_get_method("CollisionObject2D", "get_collision_layer");
	___mb.mb_get_collision_layer_bit = godot::api->godot_method_bind_get_method("CollisionObject2D", "get_collision_layer_bit");
	___mb.mb_get_collision_mask = godot::api->godot_method_bind_get_method("CollisionObject2D", "get_collision_mask");
	___mb.mb_get_collision_mask_bit = godot::api->godot_method_bind_get_method("CollisionObject2D", "get_collision_mask_bit");
	...
	___mb.mb_set_collision_layer = godot::api->godot_method_bind_get_method("CollisionObject2D", "set_collision_layer");
	___mb.mb_set_collision_layer_bit = godot::api->godot_method_bind_get_method("CollisionObject2D", "set_collision_layer_bit");
	___mb.mb_set_collision_mask = godot::api->godot_method_bind_get_method("CollisionObject2D", "set_collision_mask");
	___mb.mb_set_collision_mask_bit = godot::api->godot_method_bind_get_method("CollisionObject2D", "set_collision_mask_bit");
	...
	godot::api->godot_string_name_new_data(&class_name, "CollisionObject2D");
