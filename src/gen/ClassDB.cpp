...
void *ClassDB::_detail_class_tag = nullptr;
...
void ClassDB::___init_method_bindings() {
	...
	___mb.mb_class_get_enum_constants = godot::api->godot_method_bind_get_method("_ClassDB", "class_get_enum_constants");
	___mb.mb_class_get_enum_list = godot::api->godot_method_bind_get_method("_ClassDB", "class_get_enum_list");
	___mb.mb_class_get_integer_constant = godot::api->godot_method_bind_get_method("_ClassDB", "class_get_integer_constant");
	___mb.mb_class_get_integer_constant_enum = godot::api->godot_method_bind_get_method("_ClassDB", "class_get_integer_constant_enum");
	...
	___mb.mb_class_has_enum = godot::api->godot_method_bind_get_method("_ClassDB", "class_has_enum");
	...
	godot::api->godot_string_name_new_data(&class_name, "_ClassDB");
