...
void ___init_method_bindings()
{
	...
	AspectRatioContainer::___init_method_bindings();
	...
	AudioEffectCapture::___init_method_bindings();
	...
	AudioStreamMP3::___init_method_bindings();
	...
	CullInstance::___init_method_bindings();
	...
	EditorResourcePicker::___init_method_bindings();
	...
	EditorSceneImporterFBX::___init_method_bindings();
	EditorSceneImporterGLTF::___init_method_bindings();
	EditorScenePostImport::___init_method_bindings();
	EditorScript::___init_method_bindings();
	EditorScriptPicker::___init_method_bindings();
	...
	ExternalTexture::___init_method_bindings();
	FileDialog::___init_method_bindings();
	FileSystemDock::___init_method_bindings();
	...
	GLTFBufferView::___init_method_bindings();
	...
	GLTFSpecGloss::___init_method_bindings();
	...
	JavaScriptObject::___init_method_bindings();
	...
	OccluderShape::___init_method_bindings();
	OccluderShapeSphere::___init_method_bindings();
	...
	PackedSceneGLTF::___init_method_bindings();
	PacketPeer::___init_method_bindings();
	PacketPeerDTLS::___init_method_bindings();
	...
	PhysicsTestMotionResult::___init_method_bindings();
	...
	RoomGroup::___init_method_bindings();
	RoomManager::___init_method_bindings();
	...
	VisualShaderNodeUniformRef::___init_method_bindings();
	...
	WebXRInterface::___init_method_bindings();
