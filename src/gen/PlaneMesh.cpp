...
void *PlaneMesh::_detail_class_tag = nullptr;

void PlaneMesh::___init_method_bindings() {
	___mb.mb_get_center_offset = godot::api->godot_method_bind_get_method("PlaneMesh", "get_center_offset");
	...
	___mb.mb_set_center_offset = godot::api->godot_method_bind_get_method("PlaneMesh", "set_center_offset");
	...
	godot::api->godot_string_name_new_data(&class_name, "PlaneMesh");
