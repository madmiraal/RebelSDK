...
void EditorInterface::___init_method_bindings() {
	...
	___mb.mb_edit_script = godot::api->godot_method_bind_get_method("EditorInterface", "edit_script");
...
void EditorInterface::edit_script(const Ref<Script> script, const int64_t line, const int64_t column, const bool grab_focus) {
	___godot_icall_void_Object_int_int_bool(___mb.mb_edit_script, (const Object *) this, script.ptr(), line, column, grab_focus);
}
