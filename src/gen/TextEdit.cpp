...
void *TextEdit::_detail_class_tag = nullptr;
...
void TextEdit::___init_method_bindings() {
	...
	___mb.mb_get_line_column_at_pos = godot::api->godot_method_bind_get_method("TextEdit", "get_line_column_at_pos");
	___mb.mb_get_line_count = godot::api->godot_method_bind_get_method("TextEdit", "get_line_count");
	___mb.mb_get_line_height = godot::api->godot_method_bind_get_method("TextEdit", "get_line_height");
	___mb.mb_get_line_width = godot::api->godot_method_bind_get_method("TextEdit", "get_line_width");
	___mb.mb_get_line_wrap_count = godot::api->godot_method_bind_get_method("TextEdit", "get_line_wrap_count");
	___mb.mb_get_line_wrapped_text = godot::api->godot_method_bind_get_method("TextEdit", "get_line_wrapped_text");
	...
	___mb.mb_get_pos_at_line_column = godot::api->godot_method_bind_get_method("TextEdit", "get_pos_at_line_column");
	___mb.mb_get_rect_at_line_column = godot::api->godot_method_bind_get_method("TextEdit", "get_rect_at_line_column");
	...
	___mb.mb_get_total_gutter_width = godot::api->godot_method_bind_get_method("TextEdit", "get_total_gutter_width");
	...
	___mb.mb_has_redo = godot::api->godot_method_bind_get_method("TextEdit", "has_redo");
	___mb.mb_has_undo = godot::api->godot_method_bind_get_method("TextEdit", "has_undo");
	___mb.mb_insert_text_at_cursor = godot::api->godot_method_bind_get_method("TextEdit", "insert_text_at_cursor");
	___mb.mb_is_bookmark_gutter_enabled = godot::api->godot_method_bind_get_method("TextEdit", "is_bookmark_gutter_enabled");
	...
	___mb.mb_is_line_set_as_bookmark = godot::api->godot_method_bind_get_method("TextEdit", "is_line_set_as_bookmark");
	___mb.mb_is_line_set_as_breakpoint = godot::api->godot_method_bind_get_method("TextEdit", "is_line_set_as_breakpoint");
	___mb.mb_is_line_set_as_safe = godot::api->godot_method_bind_get_method("TextEdit", "is_line_set_as_safe");
	___mb.mb_is_line_wrapped = godot::api->godot_method_bind_get_method("TextEdit", "is_line_wrapped");
	...
	___mb.mb_is_virtual_keyboard_enabled = godot::api->godot_method_bind_get_method("TextEdit", "is_virtual_keyboard_enabled");
	...
	___mb.mb_set_bookmark_gutter_enabled = godot::api->godot_method_bind_get_method("TextEdit", "set_bookmark_gutter_enabled");
	...
	___mb.mb_set_line = godot::api->godot_method_bind_get_method("TextEdit", "set_line");
	___mb.mb_set_line_as_bookmark = godot::api->godot_method_bind_get_method("TextEdit", "set_line_as_bookmark");
	___mb.mb_set_line_as_breakpoint = godot::api->godot_method_bind_get_method("TextEdit", "set_line_as_breakpoint");
	___mb.mb_set_line_as_hidden = godot::api->godot_method_bind_get_method("TextEdit", "set_line_as_hidden");
	___mb.mb_set_line_as_safe = godot::api->godot_method_bind_get_method("TextEdit", "set_line_as_safe");
	...
	___mb.mb_set_virtual_keyboard_enabled = godot::api->godot_method_bind_get_method("TextEdit", "set_virtual_keyboard_enabled");
	...
	godot::api->godot_string_name_new_data(&class_name, "TextEdit");
