...
void Environment::___init_method_bindings() {
	...
	___mb.mb_is_glow_high_quality_enabled = godot::api->godot_method_bind_get_method("Environment", "is_glow_high_quality_enabled");
	...
	___mb.mb_set_glow_high_quality = godot::api->godot_method_bind_get_method("Environment", "set_glow_high_quality");
	...
	godot::api->godot_string_name_new_data(&class_name, "Environment");
