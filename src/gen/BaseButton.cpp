...
void *BaseButton::_detail_class_tag = nullptr;
...
void BaseButton::___init_method_bindings() {
	...
	___mb.mb_set_pressed_no_signal = godot::api->godot_method_bind_get_method("BaseButton", "set_pressed_no_signal");
	...
	godot::api->godot_string_name_new_data(&class_name, "BaseButton");
