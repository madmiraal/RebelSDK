...
void CPUParticles::___init_method_bindings() {
	...
	___mb.mb_get_emission_ring_axis = godot::api->godot_method_bind_get_method("CPUParticles", "get_emission_ring_axis");
	___mb.mb_get_emission_ring_height = godot::api->godot_method_bind_get_method("CPUParticles", "get_emission_ring_height");
	___mb.mb_get_emission_ring_inner_radius = godot::api->godot_method_bind_get_method("CPUParticles", "get_emission_ring_inner_radius");
	___mb.mb_get_emission_ring_radius = godot::api->godot_method_bind_get_method("CPUParticles", "get_emission_ring_radius");
	...
	___mb.mb_set_emission_ring_axis = godot::api->godot_method_bind_get_method("CPUParticles", "set_emission_ring_axis");
	___mb.mb_set_emission_ring_height = godot::api->godot_method_bind_get_method("CPUParticles", "set_emission_ring_height");
	___mb.mb_set_emission_ring_inner_radius = godot::api->godot_method_bind_get_method("CPUParticles", "set_emission_ring_inner_radius");
	___mb.mb_set_emission_ring_radius = godot::api->godot_method_bind_get_method("CPUParticles", "set_emission_ring_radius");
	...
	godot::api->godot_string_name_new_data(&class_name, "CPUParticles");
