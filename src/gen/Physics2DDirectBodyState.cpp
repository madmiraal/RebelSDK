...
void *Physics2DDirectBodyState::_detail_class_tag = nullptr;
...
void Physics2DDirectBodyState::___init_method_bindings() {
	...
	___mb.mb_get_velocity_at_local_position = godot::api->godot_method_bind_get_method("Physics2DDirectBodyState", "get_velocity_at_local_position");
	...
	godot::api->godot_string_name_new_data(&class_name, "Physics2DDirectBodyState");
...
Vector2 Physics2DDirectBodyState::get_velocity_at_local_position(const Vector2 local_position) const {
	return ___godot_icall_Vector2_Vector2(___mb.mb_get_velocity_at_local_position, (const Object *) this, local_position);
}
