...
void *EditorSpinSlider::_detail_class_tag = nullptr;
...
void EditorSpinSlider::___init_method_bindings() {
	...
	___mb.mb__value_input_gui_input = godot::api->godot_method_bind_get_method("EditorSpinSlider", "_value_input_gui_input");
	...
	godot::api->godot_string_name_new_data(&class_name, "EditorSpinSlider");
