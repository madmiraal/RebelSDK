...
void *ParticlesMaterial::_detail_class_tag = nullptr;
...
void ParticlesMaterial::___init_method_bindings() {
	...
	___mb.mb_get_emission_ring_axis = godot::api->godot_method_bind_get_method("ParticlesMaterial", "get_emission_ring_axis");
	___mb.mb_get_emission_ring_height = godot::api->godot_method_bind_get_method("ParticlesMaterial", "get_emission_ring_height");
	___mb.mb_get_emission_ring_inner_radius = godot::api->godot_method_bind_get_method("ParticlesMaterial", "get_emission_ring_inner_radius");
	___mb.mb_get_emission_ring_radius = godot::api->godot_method_bind_get_method("ParticlesMaterial", "get_emission_ring_radius");
	...
	___mb.mb_set_emission_ring_axis = godot::api->godot_method_bind_get_method("ParticlesMaterial", "set_emission_ring_axis");
	___mb.mb_set_emission_ring_height = godot::api->godot_method_bind_get_method("ParticlesMaterial", "set_emission_ring_height");
	___mb.mb_set_emission_ring_inner_radius = godot::api->godot_method_bind_get_method("ParticlesMaterial", "set_emission_ring_inner_radius");
	___mb.mb_set_emission_ring_radius = godot::api->godot_method_bind_get_method("ParticlesMaterial", "set_emission_ring_radius");
	...
	godot::api->godot_string_name_new_data(&class_name, "ParticlesMaterial");
