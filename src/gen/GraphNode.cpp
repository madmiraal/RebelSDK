...
void *GraphNode::_detail_class_tag = nullptr;
...
void GraphNode::___init_method_bindings() {
	...
	___mb.mb_set_slot_color_left = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_color_left");
	___mb.mb_set_slot_color_right = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_color_right");
	___mb.mb_set_slot_enabled_left = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_enabled_left");
	___mb.mb_set_slot_enabled_right = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_enabled_right");
	___mb.mb_set_slot_type_left = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_type_left");
	___mb.mb_set_slot_type_right = godot::api->godot_method_bind_get_method("GraphNode", "set_slot_type_right");
	___mb.mb_set_title = godot::api->godot_method_bind_get_method("GraphNode", "set_title");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "GraphNode");
