...
void *TabContainer::_detail_class_tag = nullptr;
...
void TabContainer::___init_method_bindings() {
	...
	___mb.mb__repaint = godot::api->godot_method_bind_get_method("TabContainer", "_repaint");
	...
	___mb.mb_get_tab_hidden = godot::api->godot_method_bind_get_method("TabContainer", "get_tab_hidden");
	___mb.mb_get_tab_icon = godot::api->godot_method_bind_get_method("TabContainer", "get_tab_icon");
	___mb.mb_get_tab_idx_at_point = godot::api->godot_method_bind_get_method("TabContainer", "get_tab_idx_at_point");
	...
	___mb.mb_is_all_tabs_in_front = godot::api->godot_method_bind_get_method("TabContainer", "is_all_tabs_in_front");
	___mb.mb_set_all_tabs_in_front = godot::api->godot_method_bind_get_method("TabContainer", "set_all_tabs_in_front");
	...
	___mb.mb_set_tab_hidden = godot::api->godot_method_bind_get_method("TabContainer", "set_tab_hidden");
	...
	godot::api->godot_string_name_new_data(&class_name, "TabContainer");
