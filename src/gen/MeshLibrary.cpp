...
void *MeshLibrary::_detail_class_tag = nullptr;
...
void MeshLibrary::___init_method_bindings() {
	...
	___mb.mb_get_item_mesh_transform = godot::api->godot_method_bind_get_method("MeshLibrary", "get_item_mesh_transform");
	...
	___mb.mb_set_item_mesh_transform = godot::api->godot_method_bind_get_method("MeshLibrary", "set_item_mesh_transform");
	...
	godot::api->godot_string_name_new_data(&class_name, "MeshLibrary");
