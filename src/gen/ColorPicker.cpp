...
void *ColorPicker::_detail_class_tag = nullptr;
...
void ColorPicker::___init_method_bindings() {
	...
	___mb.mb__sample_input = godot::api->godot_method_bind_get_method("ColorPicker", "_sample_input");
	...
	godot::api->godot_string_name_new_data(&class_name, "ColorPicker");
