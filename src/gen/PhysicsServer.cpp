...
void *PhysicsServer::_detail_class_tag = nullptr;
...
void PhysicsServer::___init_method_bindings() {
	...
	___mb.mb_body_test_motion = godot::api->godot_method_bind_get_method("PhysicsServer", "body_test_motion");
	...
	___mb.mb_set_collision_iterations = godot::api->godot_method_bind_get_method("PhysicsServer", "set_collision_iterations");
	...
	godot::api->godot_string_name_new_data(&class_name, "PhysicsServer");
