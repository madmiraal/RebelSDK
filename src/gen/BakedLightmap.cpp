...
void BakedLightmap::___init_method_bindings() {
	...
	___mb.mb_get_bounce_indirect_energy = godot::api->godot_method_bind_get_method("BakedLightmap", "get_bounce_indirect_energy");
	...
	___mb.mb_set_bounce_indirect_energy = godot::api->godot_method_bind_get_method("BakedLightmap", "set_bounce_indirect_energy");
