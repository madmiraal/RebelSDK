...
void *AcceptDialog::_detail_class_tag = nullptr;
...
void AcceptDialog::___init_method_bindings() {
	...
	___mb.mb_remove_button = godot::api->godot_method_bind_get_method("AcceptDialog", "remove_button");
	...
	godot::api->godot_string_name_new_data(&class_name, "AcceptDialog");
...
void AcceptDialog::remove_button(const Control *button) {
	___godot_icall_void_Object(___mb.mb_remove_button, (const Object *) this, button);
}
