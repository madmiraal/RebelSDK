...
void *TileMap::_detail_class_tag = nullptr;
...
void TileMap::___init_method_bindings() {
	...
	___mb.mb_is_show_collision_enabled = godot::api->godot_method_bind_get_method("TileMap", "is_show_collision_enabled");
	...
	___mb.mb_set_show_collision = godot::api->godot_method_bind_get_method("TileMap", "set_show_collision");
	...
	godot::api->godot_string_name_new_data(&class_name, "TileMap");
