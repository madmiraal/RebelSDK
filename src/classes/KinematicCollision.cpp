...
void KinematicCollision::___init_method_bindings() {
	___mb.mb_get_angle = godot::api->godot_method_bind_get_method("KinematicCollision", "get_angle");
	...
	___mb.mb_get_collider_rid = godot::api->godot_method_bind_get_method("KinematicCollision", "get_collider_rid");
