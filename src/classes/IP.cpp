...
void IP::___init_method_bindings() {
	...
	___mb.mb_get_resolve_item_addresses = godot::api->godot_method_bind_get_method("IP", "get_resolve_item_addresses");
	...
	___mb.mb_resolve_hostname_addresses = godot::api->godot_method_bind_get_method("IP", "resolve_hostname_addresses");
	___mb.mb_resolve_hostname_queue_item = godot::api->godot_method_bind_get_method("IP", "resolve_hostname_queue_item");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "IP");
