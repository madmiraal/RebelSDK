...
void *PhysicsDirectSpaceState::_detail_class_tag = nullptr;
...
void PhysicsDirectSpaceState::___init_method_bindings() {
	...
	___mb.mb_intersect_point = godot::api->godot_method_bind_get_method("PhysicsDirectSpaceState", "intersect_point");
	...
	godot::api->godot_string_name_new_data(&class_name, "PhysicsDirectSpaceState");
