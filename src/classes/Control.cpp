...
void Control::___init_method_bindings() {
	...
	___mb.mb_find_next_valid_focus = godot::api->godot_method_bind_get_method("Control", "find_next_valid_focus");
	___mb.mb_find_prev_valid_focus = godot::api->godot_method_bind_get_method("Control", "find_prev_valid_focus");
	...
	___mb.mb_get_pass_on_modal_close_click = godot::api->godot_method_bind_get_method("Control", "get_pass_on_modal_close_click");
	...
	___mb.mb_get_theme_default_font = godot::api->godot_method_bind_get_method("Control", "get_theme_default_font");
	...
	___mb.mb_set_pass_on_modal_close_click = godot::api->godot_method_bind_get_method("Control", "set_pass_on_modal_close_click");
	...
	godot::api->godot_string_name_new_data(&class_name, "Control");
...
Ref<StyleBox> Control::get_stylebox(const String name, const String theme_type) const {
	return Ref<StyleBox>::__internal_constructor(___godot_icall_Object_String_String(___mb.mb_get_stylebox, (const Object *) this, name, theme_type));
}
