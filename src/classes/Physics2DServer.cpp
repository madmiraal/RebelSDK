...
void *Physics2DServer::_detail_class_tag = nullptr;
...
void Physics2DServer::___init_method_bindings() {
	...
	___mb.mb_set_collision_iterations = godot::api->godot_method_bind_get_method("Physics2DServer", "set_collision_iterations");
	...
	godot::api->godot_string_name_new_data(&class_name, "Physics2DServer");
