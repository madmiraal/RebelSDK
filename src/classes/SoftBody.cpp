...
void *SoftBody::_detail_class_tag = nullptr;
...
void SoftBody::___init_method_bindings() {
	...
	___mb.mb_get_point_transform = godot::api->godot_method_bind_get_method("SoftBody", "get_point_transform");
	...
	___mb.mb_is_physics_enabled = godot::api->godot_method_bind_get_method("SoftBody", "is_physics_enabled");
	___mb.mb_is_point_pinned = godot::api->godot_method_bind_get_method("SoftBody", "is_point_pinned");
	...
	___mb.mb_set_physics_enabled = godot::api->godot_method_bind_get_method("SoftBody", "set_physics_enabled");
	___mb.mb_set_point_pinned = godot::api->godot_method_bind_get_method("SoftBody", "set_point_pinned");
	...
	godot::api->godot_string_name_new_data(&class_name, "SoftBody");
