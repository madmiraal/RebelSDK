...
namespace Rebel {
real_t KinematicCollision2D::get_angle(const Vector2 up_direction) const {
...
KinematicCollision2D* KinematicCollision2D::create() {
    return (KinematicCollision2D*)nativescript_1_1_api->
        rebel_nativescript_get_instance_binding_data(
            RegisterState::language_index,
            api->rebel_get_class_constructor((char *)"KinematicCollision2D")()
         );
}

void KinematicCollision2D::init_method_bindings() {
    method_bindings.mb_get_angle =
    ...
    api->rebel_string_name_new_data(&class_name, "KinematicCollision2D");
    class_tag = core_1_2_api->rebel_get_class_tag(&class_name);
    api->rebel_string_name_destroy(&class_name);
}

KinematicCollision2D::MethodBindings KinematicCollision2D::method_bindings = {};
void* KinematicCollision2D::class_tag = nullptr;
} // namespace Rebel
