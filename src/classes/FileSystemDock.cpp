...
void FileSystemDock::___init_method_bindings() {
	...
	___mb.mb__file_sort_popup = godot::api->godot_method_bind_get_method("FileSystemDock", "_file_sort_popup");
...
void FileSystemDock::navigate_to_path(const String path) {
	___godot_icall_void_String(___mb.mb_navigate_to_path, (const Object *) this, path);
}
