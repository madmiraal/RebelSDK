...
void *PhysicsDirectBodyState::_detail_class_tag = nullptr;
...
void PhysicsDirectBodyState::___init_method_bindings() {
	...
	___mb.mb_get_velocity_at_local_position = godot::api->godot_method_bind_get_method("PhysicsDirectBodyState", "get_velocity_at_local_position");
	...
	godot::api->godot_string_name_new_data(&class_name, "PhysicsDirectBodyState");
