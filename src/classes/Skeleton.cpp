...
void Skeleton::___init_method_bindings() {
	...
	___mb.mb_clear_bones_global_pose_override = godot::api->godot_method_bind_get_method("Skeleton", "clear_bones_global_pose_override");
	...
	___mb.mb_get_bone_global_pose_no_override = godot::api->godot_method_bind_get_method("Skeleton", "get_bone_global_pose_no_override");
	...
	___mb.mb_set_bone_name = godot::api->godot_method_bind_get_method("Skeleton", "set_bone_name");
	...
	godot::api->godot_string_name_new_data(&class_name, "Skeleton");
