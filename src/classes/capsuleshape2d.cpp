...
CapsuleShape2D* CapsuleShape2D::create() {
    return (CapsuleShape2D*)nativescript_1_1_api->
        rebel_nativescript_get_instance_binding_data(
            RegisterState::language_index,
            api->rebel_get_class_constructor((char *)"CapsuleShape2D")()
         );
}

void CapsuleShape2D::init_method_bindings() {
    method_bindings.mb_get_height =
    ...
    api->rebel_string_name_new_data(&class_name, "CapsuleShape2D");
    class_tag = core_1_2_api->rebel_get_class_tag(&class_name);
    api->rebel_string_name_destroy(&class_name);
}

CapsuleShape2D::MethodBindings CapsuleShape2D::method_bindings = {};
void* CapsuleShape2D::class_tag = nullptr;
} // namespace Rebel
