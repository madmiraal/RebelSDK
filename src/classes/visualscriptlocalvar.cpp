...
VisualScriptLocalVar* VisualScriptLocalVar::create() {
    return (VisualScriptLocalVar*)nativescript_1_1_api->
        rebel_nativescript_get_instance_binding_data(
            RegisterState::language_index,
            api->rebel_get_class_constructor((char *)"VisualScriptLocalVar")()
         );
}

void VisualScriptLocalVar::init_method_bindings() {
    method_bindings.mb_get_var_name =
    ...
    api->rebel_string_name_new_data(&class_name, "VisualScriptLocalVar");
    class_tag = core_1_2_api->rebel_get_class_tag(&class_name);
    api->rebel_string_name_destroy(&class_name);
}

VisualScriptLocalVar::MethodBindings VisualScriptLocalVar::method_bindings = {};
void* VisualScriptLocalVar::class_tag = nullptr;
} // namespace Rebel
