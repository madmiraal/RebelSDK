...
void *NoiseTexture::_detail_class_tag = nullptr;
...
void NoiseTexture::___init_method_bindings() {
	...
	___mb.mb_get_noise_offset = godot::api->godot_method_bind_get_method("NoiseTexture", "get_noise_offset");
	...
	___mb.mb_set_noise_offset = godot::api->godot_method_bind_get_method("NoiseTexture", "set_noise_offset");
	...
	godot::api->godot_string_name_new_data(&class_name, "NoiseTexture");
