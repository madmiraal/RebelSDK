...
void QuadMesh::___init_method_bindings() {
	___mb.mb_get_center_offset = godot::api->godot_method_bind_get_method("QuadMesh", "get_center_offset");
	___mb.mb_get_size = godot::api->godot_method_bind_get_method("QuadMesh", "get_size");
	___mb.mb_set_center_offset = godot::api->godot_method_bind_get_method("QuadMesh", "set_center_offset");
