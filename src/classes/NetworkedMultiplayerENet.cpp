...
void *NetworkedMultiplayerENet::_detail_class_tag = nullptr;
...
void NetworkedMultiplayerENet::___init_method_bindings() {
	...
	___mb.mb_get_dtls_hostname = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "get_dtls_hostname");
	...
	___mb.mb_is_dtls_enabled = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "is_dtls_enabled");
	___mb.mb_is_dtls_verify_enabled = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "is_dtls_verify_enabled");
	...
	___mb.mb_set_dtls_certificate = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_dtls_certificate");
	___mb.mb_set_dtls_enabled = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_dtls_enabled");
	___mb.mb_set_dtls_hostname = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_dtls_hostname");
	___mb.mb_set_dtls_key = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_dtls_key");
	___mb.mb_set_dtls_verify_enabled = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_dtls_verify_enabled");
	___mb.mb_set_peer_timeout = godot::api->godot_method_bind_get_method("NetworkedMultiplayerENet", "set_peer_timeout");
	...
	godot::api->godot_string_name_new_data(&class_name, "NetworkedMultiplayerENet");
