...
void *GraphEdit::_detail_class_tag = nullptr;
...
void GraphEdit::___init_method_bindings() {
	...
	___mb.mb__graph_node_slot_updated = godot::api->godot_method_bind_get_method("GraphEdit", "_graph_node_slot_updated");
	___mb.mb__gui_input = godot::api->godot_method_bind_get_method("GraphEdit", "_gui_input");
	___mb.mb__minimap_draw = godot::api->godot_method_bind_get_method("GraphEdit", "_minimap_draw");
	___mb.mb__minimap_toggled = godot::api->godot_method_bind_get_method("GraphEdit", "_minimap_toggled");
	...
	___mb.mb_get_minimap_opacity = godot::api->godot_method_bind_get_method("GraphEdit", "get_minimap_opacity");
	___mb.mb_get_minimap_size = godot::api->godot_method_bind_get_method("GraphEdit", "get_minimap_size");
	...
	___mb.mb_get_zoom_max = godot::api->godot_method_bind_get_method("GraphEdit", "get_zoom_max");
	___mb.mb_get_zoom_min = godot::api->godot_method_bind_get_method("GraphEdit", "get_zoom_min");
	___mb.mb_get_zoom_step = godot::api->godot_method_bind_get_method("GraphEdit", "get_zoom_step");
	___mb.mb_is_minimap_enabled = godot::api->godot_method_bind_get_method("GraphEdit", "is_minimap_enabled");
	...
	___mb.mb_is_showing_zoom_label = godot::api->godot_method_bind_get_method("GraphEdit", "is_showing_zoom_label");
	...
	___mb.mb_set_minimap_enabled = godot::api->godot_method_bind_get_method("GraphEdit", "set_minimap_enabled");
	___mb.mb_set_minimap_opacity = godot::api->godot_method_bind_get_method("GraphEdit", "set_minimap_opacity");
	___mb.mb_set_minimap_size = godot::api->godot_method_bind_get_method("GraphEdit", "set_minimap_size");
	...
	___mb.mb_set_show_zoom_label = godot::api->godot_method_bind_get_method("GraphEdit", "set_show_zoom_label");
	...
	___mb.mb_set_zoom_max = godot::api->godot_method_bind_get_method("GraphEdit", "set_zoom_max");
	___mb.mb_set_zoom_min = godot::api->godot_method_bind_get_method("GraphEdit", "set_zoom_min");
	___mb.mb_set_zoom_step = godot::api->godot_method_bind_get_method("GraphEdit", "set_zoom_step");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "GraphEdit");
