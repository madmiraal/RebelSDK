...
void *EditorSpatialGizmoPlugin::_detail_class_tag = nullptr;
...
void EditorSpatialGizmoPlugin::___init_method_bindings() {
	...
	godot::api->godot_string_name_new_data(&class_name, "EditorSpatialGizmoPlugin");
...
void EditorSpatialGizmoPlugin::create_handle_material(const String name, const bool billboard, const Ref<Texture> texture) {
	___godot_icall_void_String_bool_Object(___mb.mb_create_handle_material, (const Object *) this, name, billboard, texture.ptr());
}
