...
void *NavigationMesh::_detail_class_tag = nullptr;
...
void NavigationMesh::___init_method_bindings() {
	...
	godot::api->godot_string_name_new_data(&class_name, "NavigationMesh");
...
NavigationMesh::ParsedGeometryType NavigationMesh::get_parsed_geometry_type() const {
	return (NavigationMesh::ParsedGeometryType) ___godot_icall_int(___mb.mb_get_parsed_geometry_type, (const Object *) this);
}
...
NavigationMesh::SamplePartitionType NavigationMesh::get_sample_partition_type() const {
	return (NavigationMesh::SamplePartitionType) ___godot_icall_int(___mb.mb_get_sample_partition_type, (const Object *) this);
}

NavigationMesh::SourceGeometryMode NavigationMesh::get_source_geometry_mode() const {
	return (NavigationMesh::SourceGeometryMode) ___godot_icall_int(___mb.mb_get_source_geometry_mode, (const Object *) this);
}
