...
void *InputEventKey::_detail_class_tag = nullptr;

void InputEventKey::___init_method_bindings() {
	___mb.mb_get_physical_scancode = godot::api->godot_method_bind_get_method("InputEventKey", "get_physical_scancode");
	___mb.mb_get_physical_scancode_with_modifiers = godot::api->godot_method_bind_get_method("InputEventKey", "get_physical_scancode_with_modifiers");
	...
	___mb.mb_set_physical_scancode = godot::api->godot_method_bind_get_method("InputEventKey", "set_physical_scancode");
	...
	godot::api->godot_string_name_new_data(&class_name, "InputEventKey");
