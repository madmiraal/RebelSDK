...
void *ArrayMesh::_detail_class_tag = nullptr;
...
void ArrayMesh::___init_method_bindings() {
	...
	___mb.mb_clear_surfaces = godot::api->godot_method_bind_get_method("ArrayMesh", "clear_surfaces");
	...
	___mb.mb_set_blend_shape_name = godot::api->godot_method_bind_get_method("ArrayMesh", "set_blend_shape_name");
	...
	godot::api->godot_string_name_new_data(&class_name, "ArrayMesh");
