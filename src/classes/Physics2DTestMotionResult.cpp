...
void *Physics2DTestMotionResult::_detail_class_tag = nullptr;
...
void Physics2DTestMotionResult::___init_method_bindings() {
	...
	___mb.mb_get_collision_depth = godot::api->godot_method_bind_get_method("Physics2DTestMotionResult", "get_collision_depth");
	...
	___mb.mb_get_collision_safe_fraction = godot::api->godot_method_bind_get_method("Physics2DTestMotionResult", "get_collision_safe_fraction");
	___mb.mb_get_collision_unsafe_fraction = godot::api->godot_method_bind_get_method("Physics2DTestMotionResult", "get_collision_unsafe_fraction");
	...
	godot::api->godot_string_name_new_data(&class_name, "Physics2DTestMotionResult");
