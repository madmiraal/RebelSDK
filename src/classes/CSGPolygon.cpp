...
void CSGPolygon::___init_method_bindings() {
	...
	___mb.mb_get_path_interval_type = godot::api->godot_method_bind_get_method("CSGPolygon", "get_path_interval_type");
	...
	___mb.mb_get_path_simplify_angle = godot::api->godot_method_bind_get_method("CSGPolygon", "get_path_simplify_angle");
	___mb.mb_get_path_u_distance = godot::api->godot_method_bind_get_method("CSGPolygon", "get_path_u_distance");
	...
	___mb.mb_set_path_interval_type = godot::api->godot_method_bind_get_method("CSGPolygon", "set_path_interval_type");
	...
	___mb.mb_set_path_simplify_angle = godot::api->godot_method_bind_get_method("CSGPolygon", "set_path_simplify_angle");
	___mb.mb_set_path_u_distance = godot::api->godot_method_bind_get_method("CSGPolygon", "set_path_u_distance");
	...
	godot::api->godot_string_name_new_data(&class_name, "CSGPolygon");
