...
void KinematicCollision2D::___init_method_bindings() {
	___mb.mb_get_angle = godot::api->godot_method_bind_get_method("KinematicCollision2D", "get_angle");
	...
	___mb.mb_get_collider_rid = godot::api->godot_method_bind_get_method("KinematicCollision2D", "get_collider_rid");
