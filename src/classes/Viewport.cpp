...
void Viewport::___init_method_bindings() {
	...
	___mb.mb__process_picking = godot::api->godot_method_bind_get_method("Viewport", "_process_picking");
	...
	___mb.mb_get_sharpen_intensity = godot::api->godot_method_bind_get_method("Viewport", "get_sharpen_intensity");
	...
	___mb.mb_get_use_debanding = godot::api->godot_method_bind_get_method("Viewport", "get_use_debanding");
	___mb.mb_get_use_fxaa = godot::api->godot_method_bind_get_method("Viewport", "get_use_fxaa");
	...
	___mb.mb_set_sharpen_intensity = godot::api->godot_method_bind_get_method("Viewport", "set_sharpen_intensity");
	...
	___mb.mb_set_use_debanding = godot::api->godot_method_bind_get_method("Viewport", "set_use_debanding");
	___mb.mb_set_use_fxaa = godot::api->godot_method_bind_get_method("Viewport", "set_use_fxaa");
	...
	godot::api->godot_string_name_new_data(&class_name, "Viewport");
