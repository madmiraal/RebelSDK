...
void ARVRServer::___init_method_bindings() {
	___mb.mb_add_interface = godot::api->godot_method_bind_get_method("ARVRServer", "add_interface");
	___mb.mb_add_tracker = godot::api->godot_method_bind_get_method("ARVRServer", "add_tracker");
	___mb.mb_center_on_hmd = godot::api->godot_method_bind_get_method("ARVRServer", "center_on_hmd");
	___mb.mb_clear_primary_interface_if = godot::api->godot_method_bind_get_method("ARVRServer", "clear_primary_interface_if");
	...
	___mb.mb_remove_interface = godot::api->godot_method_bind_get_method("ARVRServer", "remove_interface");
	___mb.mb_remove_tracker = godot::api->godot_method_bind_get_method("ARVRServer", "remove_tracker");
	...
	godot::api->godot_string_name_new_data(&class_name, "ARVRServer");
...
Ref<ARVRPositionalTracker> ARVRServer::get_tracker(const int64_t idx) const {
	return Ref<ARVRPositionalTracker>::__internal_constructor(___godot_icall_Object_int(___mb.mb_get_tracker, (const Object *) this, idx));
}
