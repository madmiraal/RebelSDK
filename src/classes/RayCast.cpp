...
void *RayCast::_detail_class_tag = nullptr;
...
void RayCast::___init_method_bindings() {
	...
	___mb.mb_get_debug_shape_custom_color = godot::api->godot_method_bind_get_method("RayCast", "get_debug_shape_custom_color");
	___mb.mb_get_debug_shape_thickness = godot::api->godot_method_bind_get_method("RayCast", "get_debug_shape_thickness");
	...
	___mb.mb_set_debug_shape_custom_color = godot::api->godot_method_bind_get_method("RayCast", "set_debug_shape_custom_color");
	___mb.mb_set_debug_shape_thickness = godot::api->godot_method_bind_get_method("RayCast", "set_debug_shape_thickness");
	...
	godot::api->godot_string_name_new_data(&class_name, "RayCast");
