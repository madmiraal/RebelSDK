...
void *VisualScriptCustomNode::_detail_class_tag = nullptr;
...
void VisualScriptCustomNode::___init_method_bindings() {
	...
	___mb.mb__get_input_value_port_hint = godot::api->godot_method_bind_get_method("VisualScriptCustomNode", "_get_input_value_port_hint");
	___mb.mb__get_input_value_port_hint_string = godot::api->godot_method_bind_get_method("VisualScriptCustomNode", "_get_input_value_port_hint_string");
	...
	___mb.mb__get_output_value_port_hint = godot::api->godot_method_bind_get_method("VisualScriptCustomNode", "_get_output_value_port_hint");
	___mb.mb__get_output_value_port_hint_string = godot::api->godot_method_bind_get_method("VisualScriptCustomNode", "_get_output_value_port_hint_string");
	...
	godot::api->godot_string_name_new_data(&class_name, "VisualScriptCustomNode");
