...
void OS::___init_method_bindings() {
	...
	___mb.mb_get_cache_dir = godot::api->godot_method_bind_get_method("_OS", "get_cache_dir");
	...
	___mb.mb_get_config_dir = godot::api->godot_method_bind_get_method("_OS", "get_config_dir");
	...
	___mb.mb_get_data_dir = godot::api->godot_method_bind_get_method("_OS", "get_data_dir");
	...
	___mb.mb_get_locale_language = godot::api->godot_method_bind_get_method("_OS", "get_locale_language");
	...
	___mb.mb_is_delta_smoothing_enabled = godot::api->godot_method_bind_get_method("_OS", "is_delta_smoothing_enabled");
	...
	___mb.mb_set_delta_smoothing = godot::api->godot_method_bind_get_method("_OS", "set_delta_smoothing");
