...
void *AnimationPlayer::_detail_class_tag = nullptr;
...
void AnimationPlayer::___init_method_bindings() {
	...
	___mb.mb_is_reset_on_save_enabled = godot::api->godot_method_bind_get_method("AnimationPlayer", "is_reset_on_save_enabled");
	...
	___mb.mb_set_reset_on_save_enabled = godot::api->godot_method_bind_get_method("AnimationPlayer", "set_reset_on_save_enabled");
	...
	godot::api->godot_string_name_new_data(&class_name, "AnimationPlayer");
