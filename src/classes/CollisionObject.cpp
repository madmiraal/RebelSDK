...
void *CollisionObject::_detail_class_tag = nullptr;
...
void CollisionObject::___init_method_bindings() {
	...
	___mb.mb__shape_changed = godot::api->godot_method_bind_get_method("CollisionObject", "_shape_changed");
	___mb.mb__update_debug_shapes = godot::api->godot_method_bind_get_method("CollisionObject", "_update_debug_shapes");
	...
	___mb.mb_get_collision_layer = godot::api->godot_method_bind_get_method("CollisionObject", "get_collision_layer");
	___mb.mb_get_collision_layer_bit = godot::api->godot_method_bind_get_method("CollisionObject", "get_collision_layer_bit");
	___mb.mb_get_collision_mask = godot::api->godot_method_bind_get_method("CollisionObject", "get_collision_mask");
	___mb.mb_get_collision_mask_bit = godot::api->godot_method_bind_get_method("CollisionObject", "get_collision_mask_bit");
	...
	___mb.mb_set_collision_layer = godot::api->godot_method_bind_get_method("CollisionObject", "set_collision_layer");
	___mb.mb_set_collision_layer_bit = godot::api->godot_method_bind_get_method("CollisionObject", "set_collision_layer_bit");
	___mb.mb_set_collision_mask = godot::api->godot_method_bind_get_method("CollisionObject", "set_collision_mask");
	___mb.mb_set_collision_mask_bit = godot::api->godot_method_bind_get_method("CollisionObject", "set_collision_mask_bit");
	...
	godot::api->godot_string_name_new_data(&class_name, "CollisionObject");
...
void CollisionObject::_input_event(const Object *camera, const Ref<InputEvent> event, const Vector3 position, const Vector3 normal, const int64_t shape_idx) {
	___godot_icall_void_Object_Object_Vector3_Vector3_int(___mb.mb__input_event, (const Object *) this, camera, event.ptr(), position, normal, shape_idx);
}

void CollisionObject::_shape_changed(const Ref<Shape> shape) {
	___godot_icall_void_Object(___mb.mb__shape_changed, (const Object *) this, shape.ptr());
}
