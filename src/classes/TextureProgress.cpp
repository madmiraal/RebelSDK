...
void *TextureProgress::_detail_class_tag = nullptr;
...
void TextureProgress::___init_method_bindings() {
	...
	___mb.mb_get_texture_progress_offset = godot::api->godot_method_bind_get_method("TextureProgress", "get_texture_progress_offset");
	...
	___mb.mb_set_texture_progress_offset = godot::api->godot_method_bind_get_method("TextureProgress", "set_texture_progress_offset");
	...
	godot::api->godot_string_name_new_data(&class_name, "TextureProgress");
