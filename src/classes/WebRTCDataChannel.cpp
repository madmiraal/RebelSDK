...
void *WebRTCDataChannel::_detail_class_tag = nullptr;
...
void WebRTCDataChannel::___init_method_bindings() {
	...
	___mb.mb_get_buffered_amount = godot::api->godot_method_bind_get_method("WebRTCDataChannel", "get_buffered_amount");
	...
	godot::api->godot_string_name_new_data(&class_name, "WebRTCDataChannel");
