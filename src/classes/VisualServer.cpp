...
void *VisualServer::_detail_class_tag = nullptr;
...
void VisualServer::___init_method_bindings() {
	...
	___mb.mb_is_render_loop_enabled = godot::api->godot_method_bind_get_method("VisualServer", "is_render_loop_enabled");
	...
	___mb.mb_light_set_bake_mode = godot::api->godot_method_bind_get_method("VisualServer", "light_set_bake_mode");
	...
	___mb.mb_lightmap_capture_is_interior = godot::api->godot_method_bind_get_method("VisualServer", "lightmap_capture_is_interior");
	...
	___mb.mb_lightmap_capture_set_interior = godot::api->godot_method_bind_get_method("VisualServer", "lightmap_capture_set_interior");
	...
	___mb.mb_set_render_loop_enabled = godot::api->godot_method_bind_get_method("VisualServer", "set_render_loop_enabled");
	___mb.mb_set_shader_time_scale = godot::api->godot_method_bind_get_method("VisualServer", "set_shader_time_scale");
	___mb.mb_set_use_occlusion_culling = godot::api->godot_method_bind_get_method("VisualServer", "set_use_occlusion_culling");
	...
	___mb.mb_viewport_set_sharpen_intensity = godot::api->godot_method_bind_get_method("VisualServer", "viewport_set_sharpen_intensity");
	...
	___mb.mb_viewport_set_use_debanding = godot::api->godot_method_bind_get_method("VisualServer", "viewport_set_use_debanding");
	___mb.mb_viewport_set_use_fxaa = godot::api->godot_method_bind_get_method("VisualServer", "viewport_set_use_fxaa");
	___mb.mb_viewport_set_vflip = godot::api->godot_method_bind_get_method("VisualServer", "viewport_set_vflip");
	godot_string_name class_name;
	godot::api->godot_string_name_new_data(&class_name, "VisualServer");
...
void VisualServer::light_set_bake_mode(const RID light, const int64_t bake_mode) {
	___godot_icall_void_RID_int(___mb.mb_light_set_bake_mode, (const Object *) this, light, bake_mode);
}
...
void VisualServer::viewport_set_sharpen_intensity(const RID viewport, const real_t intensity) {
	___godot_icall_void_RID_float(___mb.mb_viewport_set_sharpen_intensity, (const Object *) this, viewport, intensity);
}
...
void VisualServer::viewport_set_use_debanding(const RID viewport, const bool debanding) {
	___godot_icall_void_RID_bool(___mb.mb_viewport_set_use_debanding, (const Object *) this, viewport, debanding);
}

void VisualServer::viewport_set_use_fxaa(const RID viewport, const bool fxaa) {
	___godot_icall_void_RID_bool(___mb.mb_viewport_set_use_fxaa, (const Object *) this, viewport, fxaa);
}
